...
var work = {
    "jobs": [{
        ...
        "description": "I was hired to work on Accenture right after my graduation, since I had no prior experience with Oracle Fusion Middleware or Solution Architecture I started learning about Oracle Service Bus and how do design a service orientaed archtechture works, some months later I started to teach about Oracle Service Bus and review the code sent by the remote team. Later on this role I started to learn about the Oracle SOA Suite and became a reference on the project."
    }, {
        "employer": "Accenture",
        "title": "Technology Architect Senior Analyst",
        "location": "São Paulo, São Paulo, Brasil",
        "datesWorked": "March 2013 - December 2013",
        "description": "During this period I worked with a team of experts in a performance tests seeking to improve the average response time and stability for all services inside the company."
    }, {
        "employer": "Accenture",
        "title": "Technology Architect Team Leader",
        "location": "São Paulo, São Paulo, Brasil",
        "datesWorked": "December 2013 - May 2015",
        "description": "During this time I have done many things, I participate of a Team Called Problem Solve Group (PSG) in this team we have the responsibility to undertand and address the root cause of many problems. During a crisis inside the client were I was allocated I as able to identify that a product bug which was causing a major loss of service, since this product is a packaged solution there was nothing that I could do except understand and propose a workaround which worked and became the client official Architecture."
    }, {
        "employer": "Accenture",
        "title": "Digital Business Integration Consultant",
        "location": "São Paulo, São Paulo, Brasil",
        "datesWorked": "May 2015 - Today",
        "description": "In this role so far I have the opportunity to work with IBM WorkLight(Moblile First) building a hybrid mobile application with AngularJs and Ionic for the first mobile bank in Brazil."
    }]
};
